        ...
        <div className='w-full h-[calc(100%+68px)] absolute top-0 group-hover:-translate-y-[62px] md:group-hover:-translate-y-[65px] transition duration-300 ease-in-out opacity-100 bg-gradient-to-t from-white from-35% md:from-10%'>
          <div className='absolute bottom-0'>
            <div className='px-4 py-4'>
              <h1 className='font-plusJakartaSans text-gray-900 font-bold md:text-2xl'>
                {title}
              </h1>
              <p className='font-plusJakartaSans font-normal text-gray-900 text-xs md:text-lg'>
                {desc}
              </p>
            </div>
            <div className='px-4 h-[68px] flex flex-row items-start gap-2'>
              <div className='w-fit h-12 md:h-fit border border-solid border-gray-200 rounded-md p-2 leading-tight'>
                <p className='font-plusJakartaSans text-xs text-gray-900 font-semibold'>
                  {platform}
                </p>
                <p className='font-plusJakartaSans text-[10px] sm:text-xs text-gray-400'>
                  Platform based
                </p>
              </div>
              ...
              {prod && (
                <div className='relative flex flex-col h-12 md:h-auto w-fit border border-solid border-gray-200 rounded-md p-2 leading-none'>
                  <div className='inline-flex items-center'>
                    ...
                    <p className='font-plusJakartaSans text-xs text-gray-900 font-semibold ml-2'>
                      Live in production
                    </p>
                  </div>
                  ...
                  <a
                    ...
                    className='font-plusJakartaSans text-xs text-gray-400 underline hover:text-gray-600 transition-all inline-flex items-baseline'
                  >
                    {prod}
                  </a>
                </div>
